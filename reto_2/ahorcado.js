...
var palabras = ['ATLETISMO', 'BADMINTON', 'BALONCESTO', 'BALONMANO', 'BESBOL', 'BOXEO', 'CICLISMO', 'ESGRIMA', 'FUTBOL', 'GOLF', 'NATACION', 'PATINAJE', 'SOFTBOL', 'TENIS', 'VOLEYBOL' ];
...
// captura el id "iniciar-juego" en el click y direcciona el método que inicia el juego
...
//al azar la palabra que será usada en el juego
...
// verificar la letra en que el usuario hizo clic
